...
{
    internal static class ShortcutsLabText
    {
        ...
        public const string PasteMenuLabel = "Paste Lab";
        public const string ShortcutsMenuLabel = "Shortcuts";

        public const string EditNameLabel = "Edit Name";
