namespace PowerPointLabs.TextCollection
{
    public class CommonText
    {
        ...
        #region URLs
        public const string FeedbackUrl = "https://github.com/TriasJ/BiomedPPTX/issues";
        public const string HelpDocumentUrl = "https://github.com/TriasJ/BiomedPPTX/wiki";
        public const string PowerPointLabsWebsiteUrl = "https://github.com/TriasJ/BiomedPPTX";
        public const string SingleShapeDownloadUrl = "https://github.com/TriasJ/BiomedPPTX/releases";
        # endregion

        # region Tab Labels
        public const string PowerPointLabsAddInsTabLabel = "BiomedPPTX";
        public const string PowerPointLabsMenuLabel = "BiomedPPTX";
        ...
        public const string ErrorVersionNotCompatible =
            "Some features of BiomedPPTX do not work with presentations saved in " +
        ...
        public const string ErrorOnlinePresentationNotCompatible =
            "Some features of BiomedPPTX do not work with online presentations. " +
        ...
        public const string ReportIssueEmail = @"whoopshoe@gmail.com";
        # endregion

        # region Install and Update related
        public const string QuickTutorialFileName = "Tutorial.pptx";
        public const string VstoName = "BiomedPPTXInstaller.vsto";
